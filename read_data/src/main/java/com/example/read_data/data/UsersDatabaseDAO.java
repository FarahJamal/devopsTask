...
public class UsersDatabaseDAO implements UsersDAO {
    ...
    public Users findByUsername(String username, String password) {
        ...
        return jdbcTemplate.queryForObject(sql, new UsersMapper(), username,password);
    }
    ...
    public Users loginUser(Users users) {
        ...
        try {
            ...
            return jdbcTemplate.queryForObject(sql, new UsersMapper(), users.getUsername(),users.getPassword());
